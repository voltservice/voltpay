...
final FutureProvider<List<Currency>> currenciesProvider =
    FutureProvider<List<Currency>>((Ref ref) async {
...
final Provider<List<Currency>> popularCurrenciesProvider =
  ...
  return async.maybeWhen(
    data: (List<Currency> all) => all.where((Currency c) => c.popular).toList(),
